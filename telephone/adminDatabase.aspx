<%@ Page Language="C#" Debug = "true" AutoEventWireup= "true" Codefile="onlyadmin.aspx.cs" Inherits="adminedit._Default"%>
...
<body>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
&nbsp;&nbsp;SEARCH&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txt1Search" runat="server" Height="31px"></asp:TextBox>
&nbsp;
        <asp:Button ID="Button1" runat="server" onclick="Search_Click" Text="GO" />
        <br />
